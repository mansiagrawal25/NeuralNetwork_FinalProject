...
public class Network {
    ...
    // NETWORK CONSTRUCTOR : assigning random values to bias and weights initially
    ...
    public void train(TrainSet set, int loops, int batch_size) {
        ...
        for(int i = 0; i < loops; i++) {
            ...
            System.out.println("Mean Square Error of "+batch_size+" batch = "+MSE(batch));
            //avs = avs +  MSE(batch);
        }
      //System.out.println(avs/loops);
    }
